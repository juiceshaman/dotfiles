...
local function data_diff()
    ...
    if obj.darkmode then
        obj.disp_str = hs.styledtext.new(disp_str, {font={name="Andale Mono", size=9.0, color={hex="#FFFFFF"}}})
    else
        obj.disp_str = hs.styledtext.new(disp_str, {font={name="Andale Mono", size=9.0, color={hex="#000000"}}})
    end
